                        ...
                        <div class="col-12 col-md-12 col-xl-12 position-relative">
                            <div class="card card-plain h-200">
                                <div class="card-header pb-0 p-3">
                                    <h4 class="mb-0">حذف جزوه موجود</h4>
                                    <br>

                                    <form role="form" method="get" action="{{route('document-forum.remove-document',['forum'=>$forum])}}">
                                        @csrf
                            ...
                            <table class="table">
                                ...
                                @foreach($documents as $document)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{route('document-forum.detach',['forum'=>$forum,'document'=>$document])}}" method="POST">
                                                @csrf
                                                <i class="text-2xl fa-duotone fa-minus text-warning cursor-pointer" onclick="event.preventDefault();this.closest('form').submit();"></i>
                                            </form>
                                        </td>
                                        <td>
