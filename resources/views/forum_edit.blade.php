                        ...
                        <div class="col-12 col-md-12 col-xl-12 position-relative">
                            <div class="card card-plain h-200">
                                <div class="card-header pb-0 p-3">
                                    ...
                                    <form role="form" method="post" action="{{route('forum.update',['forum' => $forum])}}">
                                        @csrf
                                        ...
                                        <div class="input-group input-group-outline input-group-dynamic mb-3">
                                            <textarea id="description" name="description" class="form-control" placeholder="توضیحات انجمن" rows="3">{{$forum->description}}</textarea>
                                        </div>
