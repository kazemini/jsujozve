                ...
                <div class="row gx-4 mb-2">
                    <div class="col-auto my-auto h-100">
                        ...
                        <p class="mb-0 font-weight-normal text-sm">
                            توی دنیای جزوه ها، پسندیدن به معنای دوست داشتن نیست. گاهی باید پسندید تا بعدا اون رو اصلاح کرد :)
                        </p>
                    </div>
                </div>
                <div class="row">
                            ...
                            <table class="table">
                                ...
                                @foreach($documents as $document)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <i class="cursor-pointer text-2xl fa-duotone fa-subtitles text-info" data-bs-toggle=modal
                                        ...
                                        <td>
                                            <form method="post"
                                                ...
                                                @csrf
                                                @method('POST')
                                                <i class="cursor-pointer text-2xl fa-duotone fa-thumbs-up
